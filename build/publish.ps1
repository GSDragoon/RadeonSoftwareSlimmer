...
dotnet publish .\src\RadeonSoftwareSlimmer\RadeonSoftwareSlimmer.csproj --force --configuration Release -p:Version=$version --framework net10.0-windows
...
Compress-Archive -Path "${publishSrcDir}\release_net10.0-windows_win-x64\*" -DestinationPath "${publishDestDir}\RadeonSoftwareSlimmer_${version}_net100.zip"
